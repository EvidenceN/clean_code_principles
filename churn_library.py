...
def rf_classification_report(y_train, y_train_preds_rf,y_test, y_test_preds_rf):
        """
        Input: 
...
def lrc_classification_report(y_train, y_train_preds_lr,y_test, y_test_preds_lr):
        """
        Input: 
                Y_train - training data
