...
def test_encoder_helper(encoder_helper):
	...
	try:
		...
		logging.error("Testing encoding_helper: categorical columns were not successfully encoded")
	# Don't know how to do assert statement to check the results
...
def test_cols_to_keep(cols_to_keep):
	...
	try:
		...
		logging.error("Testing feature_engineering: columns were not transformed")
	# Don't know how to do assert statement to check the results
...
def test_train_models(training_models):
	...
	try:
		...
		logging.error("test_train_models: Training and test data was not split sucessfully")
	# Don't know how to do assert statement to check the results	
